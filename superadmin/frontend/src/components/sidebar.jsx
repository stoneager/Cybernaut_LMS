...
const menuItems = [
  ...
  { id: "students", icon: <FaUsers />, label: "Student Management", path: "/students" },
...
const handleLogout = async () => {
  ...
  return (
    <aside
      ...
      className={`h-screen ${expanded ? "w-64" : "w-18"} bg-white border-r border-gray-200 shadow-sm flex flex-col justify-between fixed top-0 left-0 z-50 transition-all duration-300 ease-in-out`}
    >
      <div>
